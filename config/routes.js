...
module.exports = app => {
    ...
    app.delete('/rmCar/:id', restrictedPages.hasRole('Admin'), controllers.admin.rmCar)
    app.get('/rmCar', restrictedPages.hasRole('Admin'), controllers.admin.removePage)
    
    //Edit route
    app.get('/edit/:id', restrictedPages.hasRole('Admin'), controllers.admin.editCar)
    app.put('/edit/:id', restrictedPages.hasRole('Admin'), controllers.admin.updateCar)
